...
payload = {"walletAgent": str(data['payload']['walletAgent']), "transaction": {"bytes" :  bytes , "inputScripts" : inputScripts, "inputTransactions" : txs_raw_hex, "masterKeys": masterKeys, "chainPaths" : chainPaths},"verifications": { "otp": "123456", "code": "234567" }}
pp.pprint(payload)
command = "keychains"
